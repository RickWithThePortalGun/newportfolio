  ...
  return (
    <div className="bg-transparent pt-[100px] pl-[70px] max-sm:px-[30px]">
      <div className="h-fit max-sm:px-[30px] flex flex-row items-end max-sm:items-start max-sm:flex-col max-sm:pl-0">
        <span id="skill-text">
          <p className="subtopic text-[40px]">Mastery of Craft.</p>
        </span>
        <motion.p
          ...
          initial={`hidden`}
          whileInView={`show`}
          className="text-white pl-[40px] max-sm:pl-0  tools_tech font-semibold pt-10 text-[18px] font-sans"
        >
        ...
        <div className=" flex flex-row gap-4">
          <motion.p
            ...
            initial={`hidden`}
            whileInView={`show`}
            className="flex flex-row gap-2 items-center text-grey text-[15px] ml-[100px] max-sm:ml-0 justify-center max-sm:justify-start"
          >
            <svg
          ...
          <motion.p
            ...
            initial={`hidden`}
            whileInView={`show`}
            className="flex flex-row gap-2 items-center text-grey text-[15px] max-sm:pl-0 pl-[50px] justify-center max-sm:justify-start"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="10"
